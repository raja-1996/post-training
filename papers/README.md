...
Detailed, content-complete summaries of individual papers (mostly surveys).
The summaries are written to be read **instead of** the source PDF.

| File | Paper | Year | Type |
|------|-------|------|------|
